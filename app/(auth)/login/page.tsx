  ...
  return (
    <div className="min-h-screen w-full lg:grid lg:grid-cols-2">
      ...
      <div className="flex flex-col px-4 py-8 sm:px-8 h-full bg-background relative z-10 animate-in fade-in slide-in-from-left-8 duration-700">
        ...
        <div className="mt-12 text-center text-sm text-muted-foreground max-w-sm mx-auto">
          By continuing, you agree to Studix&apos;s Terms of Service and Privacy Policy.
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-col justify-center items-center relative bg-muted/40 p-12 overflow-hidden border-l">
        ...
        <div className="relative z-10 max-w-md text-center space-y-6 animate-in fade-in zoom-in-95 duration-1000 delay-150">
          ...
          <h2 className="text-3xl font-bold tracking-tight">Your intelligent student workspace.</h2>
          <p className="text-lg text-muted-foreground">Consolidate your courses, track study sessions, and utilize an AI tutor designed specifically for your semester.</p>
        </div>
